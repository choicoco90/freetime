...
class FreeTimeController(
    ...
    @GetMapping("/{userId}")
    @Schema(description = "게스트 빈 시간 조회 (ReadOnly, 미팅 정보 미포함)")
    ...
    @Schema(description = "일간 빈 시간 수정 및 추가")
    fun updateDaily(
        @RequestAttribute userId: Long,
